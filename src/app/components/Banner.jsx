...
export default function Banner() {
  return (
    <div className={styles.bhead}>
        <div className='text-3xl mx-auto my-auto bg-white w-[50%] h-[350px] rounded-3xl shadow-lg shadow-gray-600 text-center'> 
            ...
            <p className='text-3xl mt-16'>Everything works Perfect with Perfection</p>
